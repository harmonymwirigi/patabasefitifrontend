...
const UserManagement: React.FC = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      try {
        ...
        // const response = await axios.get(`/api/v1/admin/users?status=${filter}&role=${roleFilter}`, {
        ...
        setTimeout(() => {
          const mockUsers: User[] = [
            {
              ...
              last_login: "2025-05-12T08:45:22Z",
              token_balance: 50,
              profile_image: null,
            ...
            },
            {
              ...
              last_login: "2025-05-13T09:20:15Z",
              token_balance: 120,
            ...
            },
            {
              ...
              created_at: "2025-03-05T09:45:12Z",
              last_login: "2025-04-28T16:30:00Z",
              token_balance: 0,
              profile_image: null,
            ...
            },
            {
              ...
              full_name: "Elizabeth Wanjiku",
              role: "owner",
              account_status: "inactive",
              created_at: "2025-03-22T11:30:45Z",
              last_login: "2025-04-15T10:20:30Z",
              token_balance: 75,
              profile_image: "/api/placeholder/40/40",
            ...
            },
            {
              ...
              last_login: "2025-05-13T07:15:00Z",
              token_balance: 500,
              profile_image: "/api/placeholder/40/40",
          ...
          if (filter !== 'all') {
            filteredUsers = filteredUsers.filter(u => u.account_status === filter);
          }
    ...
    fetchUsers();
  }, [token, filter, roleFilter, searchTerm]);
  ...
  const handleStatusChange = async (id: number, status: 'active' | 'inactive' | 'suspended') => {
    ...
    try {
      ...
      // await axios.put(`/api/v1/admin/users/${id}/status`, 
      //   { status },
      //   { headers: { Authorization: `Bearer ${token}` }}
      // );
                      ...
                      <div className="flex items-center mb-4">
                        <div className="h-12 w-12 flex-shrink-0">
                          {selectedUser.profile_image ? (
                            <img className="h-12 w-12 rounded-full" src={selectedUser.profile_image} alt="" />
                          ) : (
